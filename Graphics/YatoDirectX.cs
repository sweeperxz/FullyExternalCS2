...
// https://github.com/YatoDev/Yato.DirectXOverlay
...
namespace Yato.DirectXOverlay
{
    public class Direct2DRenderer : IDisposable
    {
        ...
        public IntPtr RenderTargetHwnd { get; }
        ...
        private void setupInstance(Direct2DRendererOptions options)
        {
            ...
            device.TextAntialiasMode = options.AntiAliasing ? TextAntialiasMode.Cleartype : TextAntialiasMode.Aliased;
            sharedBrush = new SolidColorBrush(device, default);
        }
        ...
        public void BeginScene()
        {
            ...
            if (isDrawing) return;
            if (MeasureFPS && !stopwatch.IsRunning) stopwatch.Restart();
            if (resize)
            {
        ...
        {
            sharedFont = new TextFormat(fontFactory, fontFamilyName, bold ? FontWeight.Bold : FontWeight.Normal,
                italic ? FontStyle.Italic : FontStyle.Normal, size);
            sharedFont.WordWrapping = WordWrapping.NoWrap;
        }
        ...
        {
            var font = new TextFormat(fontFactory, options.FontFamilyName,
        ...
        public void BorderedLine(float start_x, float start_y, float end_x, float end_y, float stroke,
            Direct2DColor color, Direct2DColor borderColor)
        {
        ...
        public void BorderedLine(float start_x, float start_y, float end_x, float end_y, float stroke,
            Direct2DBrush brush, Direct2DBrush borderBrush)
        {
            var geometry = new PathGeometry(factory);
            var sink = geometry.Open();
            var half = stroke / 2.0f;
        ...
        public void BorderedRectangle(float x, float y, float width, float height, float stroke, Direct2DColor color,
            Direct2DColor borderColor)
        {
            var half = stroke / 2.0f;
            width += x;
            height += y;
        ...
        public void BorderedRectangle(float x, float y, float width, float height, float stroke, Direct2DBrush brush,
            Direct2DBrush borderBrush)
        {
            var half = stroke / 2.0f;
            width += x;
            height += y;
        ...
        public void BorderedCircle(float x, float y, float radius, float stroke, Direct2DColor color,
            Direct2DColor borderColor)
        {
            sharedBrush.Color = color;
        ...
        public void BorderedCircle(float x, float y, float radius, float stroke, Direct2DBrush brush,
            Direct2DBrush borderBrush)
        {
            var ellipse = new Ellipse(new RawVector2(x, y), radius, radius);
        ...
        public void DrawTriangle(float a_x, float a_y, float b_x, float b_y, float c_x, float c_y, float stroke,
            Direct2DBrush brush)
        {
            var geometry = new PathGeometry(factory);
            var sink = geometry.Open();
        ...
        public void DrawBox2D(float x, float y, float width, float height, float stroke, Direct2DColor interiorColor,
            Direct2DColor color)
        {
            var geometry = new PathGeometry(factory);
            var sink = geometry.Open();
        ...
        public void DrawBox2D(float x, float y, float width, float height, float stroke, Direct2DBrush interiorBrush,
            Direct2DBrush brush)
        {
            var geometry = new PathGeometry(factory);
            var sink = geometry.Open();
        ...
        public void DrawArrowLine(float start_x, float start_y, float end_x, float end_y, float size,
            Direct2DColor color)
        {
        ...
        public void DrawVerticalBar(float percentage, float x, float y, float width, float height, float stroke,
            Direct2DColor interiorColor, Direct2DColor color)
        {
            var half = stroke / 2.0f;
            var quarter = half / 2.0f;
            sharedBrush.Color = color;
        ...
        public void DrawVerticalBar(float percentage, float x, float y, float width, float height, float stroke,
            Direct2DBrush interiorBrush, Direct2DBrush brush)
        {
            var half = stroke / 2.0f;
            var quarter = half / 2.0f;
            var rect = new RawRectangleF(x - half, y - half, x + width + half, y + height + half);
        ...
        public void DrawHorizontalBar(float percentage, float x, float y, float width, float height, float stroke,
            Direct2DColor interiorColor, Direct2DColor color)
        {
            var half = stroke / 2.0f;
            sharedBrush.Color = color;
        ...
        private readonly Stopwatch swastikaDeltaTimer = new();
        ...
        public void RotateSwastika(float x, float y, float size, float stroke, Direct2DColor color)
        {
            ...
            if (rotationState > size) rotationState = size * -1.0f;
            sharedBrush.Color = color;
        ...
        {
            Bitmap bitmap = bmp;
            device.DrawBitmap(bitmap, new RawRectangleF(x, y, x + bitmap.PixelSize.Width, y + bitmap.PixelSize.Height),
        ...
        {
            Bitmap bitmap = bmp;
            device.DrawBitmap(bitmap, new RawRectangleF(x, y, x + width, y + height), opacity,
        ...
        {
            sharedBrush.Color = color;
            device.DrawText(text, text.Length, font, new RawRectangleF(x, y, float.MaxValue, float.MaxValue),
                sharedBrush, DrawTextOptions.NoSnap, MeasuringMode.Natural);
        }

        public void DrawText(string text, float x, float y, Direct2DFont font, Direct2DBrush brush)
        {
            device.DrawText(text, text.Length, font, new RawRectangleF(x, y, float.MaxValue, float.MaxValue), brush,
        ...
        public void DrawTextWithBackground(string text, float x, float y, Direct2DFont font, Direct2DColor color,
            Direct2DColor backgroundColor)
        {
            var layout = new TextLayout(fontFactory, text, font, float.MaxValue, float.MaxValue);
            ...
            device.FillRectangle(
                new RawRectangleF(x - modifier, y - modifier, x + layout.Metrics.Width + modifier,
                    y + layout.Metrics.Height + modifier), sharedBrush);
            sharedBrush.Color = color;
            device.DrawTextLayout(new RawVector2(x, y), layout, sharedBrush, DrawTextOptions.NoSnap);
            layout.Dispose();
        }

        public void DrawTextWithBackground(string text, float x, float y, Direct2DFont font, Direct2DBrush brush,
            Direct2DBrush backgroundBrush)
        {
            var layout = new TextLayout(fontFactory, text, font, float.MaxValue, float.MaxValue);
            var modifier = layout.FontSize / 4.0f;
            device.FillRectangle(
                new RawRectangleF(x - modifier, y - modifier, x + layout.Metrics.Width + modifier,
                    y + layout.Metrics.Height + modifier), backgroundBrush);
            device.DrawTextLayout(new RawVector2(x, y), layout, brush, DrawTextOptions.NoSnap);
            layout.Dispose();
        }

        public void DrawTextWithBackground(string text, float x, float y, float fontSize, Direct2DFont font,
            Direct2DColor color, Direct2DColor backgroundColor)
        {
            var layout = new TextLayout(fontFactory, text, font, float.MaxValue, float.MaxValue);
            layout.SetFontSize(fontSize, new TextRange(0, text.Length));
        ...
        public void DrawTextWithBackground(string text, float x, float y, float fontSize, Direct2DFont font,
            Direct2DBrush brush, Direct2DBrush backgroundBrush)
        {
            var layout = new TextLayout(fontFactory, text, font, float.MaxValue, float.MaxValue);
            layout.SetFontSize(fontSize, new TextRange(0, text.Length));
            var modifier = fontSize / 4.0f;
    ...
    public class Direct2DBrush
    {
        ...
        {
            Brush = new SolidColorBrush(renderTarget, default);
        }
    ...
    {
        private readonly FontFactory factory;
        ...
        public string FontFamilyName
        {
            ...
            set
            {
                ...
                Font.WordWrapping = wordWrapping
        ...
        public bool Italic
        {
            ...
            set
            {
                ...
                var wordWrapping = WordWrapping;
                Font.Dispose();
                Font = new TextFormat(factory, familyName, bold ? FontWeight.Bold : FontWeight.Normal,
        ...
        public bool WordWrapping
        {
            ...
            set => Font.WordWrapping =
                value ? SharpDX.DirectWrite.WordWrapping.Wrap : SharpDX.DirectWrite.WordWrapping.NoWrap;
        }
        ...
        public Direct2DFont(FontFactory factory, string fontFamilyName, float size, bool bold = false,
            bool italic = false)
        {
    ...
    {
        public Direct2DRenderer Renderer { get; }
    ...
    {
        private static readonly ImagingFactory factory = new();
        ...
        private void loadBitmap(RenderTarget device, byte[] bytes)
        {
            ...
            var decoder = new BitmapDecoder(factory, stream, DecodeOptions.CacheOnDemand);
...
namespace Yato.DirectXOverlay
{
    public class OverlayManager : IDisposable
    {
        ...
        public bool IsParentWindowVisible { get; }

        private OverlayManager()
        {
        }

        public OverlayManager(IntPtr parentWindowHandle, bool vsync = false, bool measurefps = false,
        ...
        private void setupInstance(IntPtr parentWindowHandle, Direct2DRendererOptions options)
        {
            ...
            serviceThread = new Thread(windowServiceThread)
            {
                IsBackground = true,
        ...
        private void windowServiceThread()
        {
            ...
            while (!exitThread)
            {
                ...
                {
                    var windowAboveParentWindow = PInvoke.GetWindow(ParentWindowHandle, 3 /* GW_HWNDPREV */);
                    if (windowAboveParentWindow != Window.WindowHandle)
                        PInvoke.SetWindowPos(Window.WindowHandle, windowAboveParentWindow, 0, 0, 0, 0,
...
namespace Yato.DirectXOverlay
{
    ...
    public class OverlayWindow : IDisposable
    {
        ...
        private void setupInstance(int x = 0, int y = 0, int width = 800, int height = 600)
        {
            ...
            var randomWindowName = string.Empty; //generateRandomString(5, 11);
            ...
            if (BypassTopmost)
                ...
                exStyle = 0x8 | 0x20 | 0x80000 | 0x80 |
                          0x8000000; // WS_EX_TOPMOST | WS_EX_TRANSPARENT | WS_EX_LAYERED |WS_EX_TOOLWINDOW | WS_EX_NOACTIVATE
        ...
        private IntPtr windowProcedure(IntPtr hwnd, PInvoke.WindowsMessage msg, IntPtr wParam, IntPtr lParam)
        {
            switch (msg)
            {
                ...
                case PInvoke.WindowsMessage.WM_ERASEBKGND:
                    PInvoke.SendMessage(WindowHandle, PInvoke.WindowsMessage.WM_PAINT, 0, 0);
                    break;
        ...
        private string generateRandomString(int minlen, int maxlen)
        {
            ...
            for (var i = 0; i < chars.Length; i++) chars[i] = (char)rng.Next(97, 123);
        ...
        private string getExecutableName()
        {
            ...
            return name.Contains(@"\") ? Path.GetFileNameWithoutExtension(name) : name;
        }
...
namespace Yato.DirectXOverlay
{
    internal static class PInvoke
    {
        public static int GetRealWindowRect(IntPtr hwnd, out RECT rect)
        {
            ...
            var dif_x = windowWidth > clientRect.Right
                ? windowWidth - clientRect.Right
                : clientRect.Right - windowWidth;
            var dif_y = windowHeight > clientRect.Bottom
        ...
        public static CreateWindowEx_t CreateWindowEx =
            WinApi.GetMethod<CreateWindowEx_t>("user32.dll", "CreateWindowExW");

        [UnmanagedFunctionPointer(CallingConvention.StdCall, CharSet = CharSet.Unicode)]
        public delegate ushort RegisterClassEx_t(ref WNDCLASSEX wndclassex);

        public static RegisterClassEx_t RegisterClassEx =
            WinApi.GetMethod<RegisterClassEx_t>("user32.dll", "RegisterClassExW");

        [UnmanagedFunctionPointer(CallingConvention.StdCall, CharSet = CharSet.Unicode)]
        public delegate int UnregisterClass_t(string lpClassName, IntPtr hInstance);

        public static UnregisterClass_t UnregisterClass =
            WinApi.GetMethod<UnregisterClass_t>("user32.dll", "UnregisterClassW");

        public delegate bool SetLayeredWindowAttributes_t(IntPtr hwnd, uint crKey, byte bAlpha, uint dwFlags);

        public static SetLayeredWindowAttributes_t SetLayeredWindowAttributes =
            WinApi.GetMethod<SetLayeredWindowAttributes_t>("user32.dll", "SetLayeredWindowAttributes");

        public delegate int TranslateMessage_t(ref Message msg);

        public static TranslateMessage_t TranslateMessage =
            WinApi.GetMethod<TranslateMessage_t>("user32.dll", "TranslateMessage");

        [UnmanagedFunctionPointer(CallingConvention.StdCall, CharSet = CharSet.Unicode)]
        public delegate int PeekMessageW_t(ref Message msg, IntPtr hwnd, uint filterMin, uint filterMax,
            uint removeMsg);
        ...
        public static DispatchMessage_t DispatchMessage =
            WinApi.GetMethod<DispatchMessage_t>("user32.dll", "DispatchMessageW");
        ...
        public static IsWindowVisible_t IsWindowVisible =
            WinApi.GetMethod<IsWindowVisible_t>("user32.dll", "IsWindowVisible");
        ...
        public delegate int SetWindowPos_t(IntPtr hwnd, IntPtr hwndInsertAfter, int x, int y, int cx, int cy,
            uint flags);
        ...
        public static IsProcessDPIAware_t IsProcessDPIAware =
            WinApi.GetMethod<IsProcessDPIAware_t>("user32.dll", "IsProcessDPIAware");
        ...
        public static DwmExtendFrameIntoClientArea_t DwmExtendFrameIntoClientArea =
            WinApi.GetMethod<DwmExtendFrameIntoClientArea_t>("dwmapi.dll", "DwmExtendFrameIntoClientArea");
        ...
        internal static class WinApi
        {
            ...
            [DllImport("kernel32.dll", EntryPoint = "GetModuleHandleW", SetLastError = false,
